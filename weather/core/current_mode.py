def show_current_basics(weather_data: dict):
...
def show_current_all(weather_data: dict):
    print(
        ...
        f"Weather desc: {weather_data['weatherDesc'][0]['value']}\n"
        f"Weather icon url: {weather_data['weatherIconUrl'][0]['value']}\n"
